...
const CREATE_STATISTICS = 'CREATE TABLE IF NOT EXISTS statistics (id INTEGER PRIMARY KEY, track_id INTEGER NOT NULL, favorite INTEGER, plays_count INTEGER, last_played_time TEXT)';
